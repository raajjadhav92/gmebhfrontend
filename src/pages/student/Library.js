  ...
  const fetchMyBooks = async () => {
    try {
      ...
      if (response.data.success) {
        const { currentBooks, transactions } = response.data.data;
        
        // Set current books (books currently issued)
        setCurrentBooks(currentBooks || []);
        
        // Set all transaction history (both current and past)
    ...
    <div className="space-y-6">
      ...
      {showBookDetails && selectedBook && (
        <div className="bg-white shadow rounded-lg overflow-hidden">
          <div className="px-4 py-5 sm:px-6 bg-primary-600 text-white flex justify-between items-center">
            <div>
              <h3 className="text-lg leading-6 font-medium">Book Details</h3>
              <p className="mt-1 max-w-2xl text-sm">{selectedBook.title} by {selectedBook.author}</p>
            </div>
            <button
          ...
          <div className="border-t border-gray-200 px-4 py-5 sm:p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h4 className="text-lg font-medium text-gray-800 mb-4">Book Information</h4>
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{selectedBook.bookId}</p>
                  </div>
                  <div>
              ...
              <div>
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  {!selectedBook.available && selectedBook.expectedReturnDate && (
                    <div>
                      <p className="text-sm text-gray-500">Expected Return Date</p>
                      <p className="font-medium">
                        {new Date(selectedBook.expectedReturnDate).toLocaleDateString()}
                      </p>
                    </div>
                  )}
                </div>
